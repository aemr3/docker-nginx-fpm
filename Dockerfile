...
RUN \
    ...
    php7-dom php7-simplexml php7-xmlreader php7-xmlwriter php7-ctype php7-mbstring php7-gd php7-bcmath php7-pdo php7-pdo_mysql \
    php7-gmp php7-memcached php7-redis php7-mongodb php7-opcache php7-pear php7-pspell php7-soap php7-zip && \
