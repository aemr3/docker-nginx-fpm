...
RUN \
    ...
    php7 php7-fpm php7-mysqli php7-json php7-openssl php7-curl php7-zlib php7-xml php7-phar \
    php7-intl php7-dom php7-xmlreader php7-ctype php7-mbstring php7-gd php7-imagick php7-bcmath \
    php7-gmp php7-memcached php7-mcrypt php7-redis php7-opcache php7-pear php7-pspell php7-soap php7-zip && \
